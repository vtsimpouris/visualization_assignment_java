...
public class RaycastRenderer extends Renderer implements TFChangeListener {
    ...
    private short getVoxelTrilinear(double[] coord) {
        ...
        //neighbors voxels
        short v000 = volume.getVoxel(c000_x,c000_y,c000_z);
        short v001 = volume.getVoxel(c001_x,c001_y,c001_z);
        short v010 = volume.getVoxel(c010_x,c010_y,c010_z);
        short v011 = volume.getVoxel(c011_x,c011_y,c011_z);
        short v100 = volume.getVoxel(c100_x,c100_y,c100_z);
        short v101 = volume.getVoxel(c101_x,c101_y,c101_z);
        ...
        // for debuging
        short nn = volume.getVoxel(x, y, z);
        //short returned = (short) Math.floor(v_g);
        
        //return trilinear interpolation value
        return (short) Math.floor(v_g);
        // Finally, get the voxel from the Volume for the corresponding coordinates
        //return volume.getVoxel(x, y, z);
        //return 0;
    }
